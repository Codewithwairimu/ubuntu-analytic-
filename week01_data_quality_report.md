...
The source dataset is `week01-nairobi-supply-chain.csv'
...
The analysis was completed in the Jupyter notebook `week01_supply_chain_eda.ipynb` using Python, pandas, NumPy, Matplotlib, and Seaborn.
